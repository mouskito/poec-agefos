                  ...
                  <td>
                    <?php 
                        ...
                        if (sizeof($subclasses) == 0) {
                          echo 'Pas de sous-catégorie dispo  : ';
                        } else {
                            foreach($subclasses as $subclass) {
                                echo '<div class="row" style="margin-bottom:7px"><div class="col-md-6">'.$subclass->body.'</div>';
                          ...
                          echo '<div class="row"><div class="col-md-3 col-md-offset-9"><a
                                 class="btn btn-success btn-xs"
                                href="'.$urlSubclassAdd.'">Ajouter Sc
                                </a></div></div>';
                         ?>
                    </td>
              <td>
